"""PocketFlow — minimal LLM workflow framework (vendored)."""
...
class BaseNode:
    ...
    def next(self, node: "BaseNode", action: str = "default"):
...
class BatchNode(Node):
    def _exec(self, prep_res) -> Any:
        return [super(BatchNode, self)._exec(i) for i in (prep_res or [])]
...
class AsyncNode(Node):
    ...
    def _run(self, shared) -> Any:
        raise RuntimeError("Use run_async.")


class AsyncBatchNode(AsyncNode, BatchNode):
    async def _exec(self, prep_res) -> Any:
